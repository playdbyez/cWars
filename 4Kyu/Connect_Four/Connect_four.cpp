...
int main()
{
   ...
   for (int i = 0; i < tots; i++) {  for (int j = 0; j < cols; j++){board [i][j] = 'O'; if (j >= 7) {board[i][j] = '\0';}}}
...
if (pieces[i][0] == 'A' && pieces[i][2] == 'Y'){board[Alv][0] = 'Y'; 
    for (int i = 0; i < tots; i++) {  if (ext == 1){break;}
     for (int j = 0 ; j < cols; j++){
                    if ( board[i][j] == p2 && board[i+1][j] == p2 ) { if(board[i+2][j] == p2 && board[i+3][j] == p2)            { if (i+3 >= 0  && i+3 <= 6){ ext = 1;sel = p2; break;}}}
                    if ( board[i][j] == p2 && board[i-1][j] == p2 ) { if(board[i-2][j] == p2 && board[i-3][j] == p2)            {if (i-3 >= 0 && i-3 <= 6){ ext = 1;sel = p2; break;}}}
                    if (board[i][j] == p2 && board[i+1][j+1] == p2) {if(board[i+2][j+2] == p2 && board[i+3][j+3] == p2)     {if (i+3 >= 0 && i+3 <= 6){if (j+3 >= 0 && j+3 <= 6){ ext = 1;sel = p2; break;}}}}
                    if (board[i][j] == p2 && board[i+1][j-1] == p2) {if ( board[i+2][j-2] == p2 && board[i+3][j-3] == p2)   {if (i+3 >= 0 && i+3 <= 6){if (j-3 >= 0 && j-3 <= 6){ext = 1;sel = p2; break;}}}}    
                    if (board[i][j] == p2 && board[i][j+1] == p2)   {if ( board[i][j+2] == p2 && board[i][j+3] == p2)       {if (j+3 >= 0 && j+3 <= 6){ ext = 1; sel = p2; break;}}}
                    if (board[i][j] == p2 && board[i][j-1] == p2)   {if ( board[i][j-2] == p2 && board[i][j-3] == p2)       {if (j-3 >= 0 && j-3 <= 6){ ext = 1;sel = p2; break;}}}
                    if (board[i][j] == p2 && board[i-1][j+1] == p2){if ( board[i-2][j+2] == p2 && board[i-3][j+3] == p2){if (i-3 >= 0 && i-3 <= 6){if (j+3 >= 0 && j+3 <= 6){ ext = 1;sel = p2; break;}}}}
                    if (board[i][j] == p2 && board[i-1][j-1] == p2){if ( board[i-2][j-2] == p2 && board[i-3][j-3] == p2){if (i-3 >= 0 && i-3 <= 6){if (j-3 >= 0 && j-3 <= 6){ ext = 1;sel = p2; break;}}}}
                    }
     ...
     for (int j = 0 ; j < cols; j++){
                    ...
                    if (board[i][j] == p2 && board[i][j-1] == p2){if ( board[i][j-2] == p2 && board[i][j-3] == p2){if (j-3 >= 0 && j-3 <= 6){ ext = 1;sel = p2; break;}}}
                    if (board[i][j] == p2 && board[i-1][j+1] == p2){if ( board[i-2][j+2] == p2 && board[i-3][j+3] == p2){if (i-3 >= 0 && i-3 <= 6){if (j+3 >= 0 && j+3 <= 6){ ext = 1;sel = p2; break;}}}}
                    if (board[i][j] == p2 && board[i-1][5] == p2){if ( board[i-2][j-2] == p2 && board[i-3][j-3] == p2){if (i-3 >= 0 && i-3 <= 6){if (j-3 >= 0 && j-3 <= 6){ ext = 1;sel = p2; break;}}}}
                    }
       }Glv--;break;}  
